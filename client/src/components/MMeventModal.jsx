                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div> {isRegistered ? (
                        ...
                        <form className="space-y-4 max-h-[120vh] overflow-y-auto pr-2" onSubmit={handleSubmit}>
                            ...
                            <input type="text" name="name4" placeholder="Member 4 Name (Optional)" value={mmContestant.name4} onChange={handleChange} required className="w-full rounded-lg bg-slate-800 px-4 py-2 text-white placeholder-slate-400 border border-slate-700 focus:border-cyan-400 focus:ring focus:ring-cyan-400/50" />
                            <input type="email" name="email4" placeholder="Member 4 Email (Optional)" value={mmContestant.email4} onChange={handleChange} required className="w-full rounded-lg bg-slate-800 px-4 py-2 text-white placeholder-slate-400 border border-slate-700 focus:border-cyan-400 focus:ring focus:ring-cyan-400/50" />
                            <input type="tel" name="phone4" placeholder="Member 4 Whatsapp Number (Optional)" value={mmContestant.phone4} onChange={handleChange} className="w-full rounded-lg bg-slate-800 px-4 py-2 text-white placeholder-slate-400 border border-slate-700 focus:border-cyan-400 focus:ring focus:ring-cyan-400/50" />
