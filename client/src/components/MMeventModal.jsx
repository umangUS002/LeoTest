                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div> {isRegistered ? (
                        ...
                        <form className="space-y-4 max-h-[70vh] max-sm:overflow-y-auto pr-2" onSubmit={handleSubmit}>
                            ...
                            <input type="text" name="teamId" placeholder="Team Id (Pantheon Team ID)" value={mmContestant.teamId} onChange={handleChange} className="w-full rounded-lg bg-slate-800 px-4 py-2 text-white placeholder-slate-400 border border-slate-700 focus:border-cyan-400 focus:ring focus:ring-cyan-400/50" />
