              ...
              <div className='flex flex-col justify-between max-w-1/2 max-sm:max-w-full mx-auto gap-0 md:gap-5'>
                ...
                {event.status === 'Partially Completed' ? (
                  <div>
                    ...
                    <button onClick={() => navigate('')} className="w-full cursor-pointer max-sm:mt-3 mt-2 bg-green-500/10 text-green-600 font-semibold px-4 py-2 rounded-lg border border-green-500/20 text-center">
                      Voting Page
                    </button>
                    <button onClick={() => navigate('')} className="w-full cursor-pointer max-sm:mt-3 mt-2 bg-green-500/10 text-green-600 font-semibold px-4 py-2 rounded-lg border border-green-500/20 text-center">
                      Voting Results
